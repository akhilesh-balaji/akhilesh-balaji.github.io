...
export default function Social(props: SocialProps) {
  return (
    ...
    >
      ...
      <a href="https://github.com/akhilesh-balaji">
        <button
          class="btn btn-soft btn-circle p-2"
          type="button"
        >
      ...
      <a href="mailto:akhilesh.balaji.bangalore[at]gmail.com">
        <button
          class="btn btn-soft btn-circle p-2"
          type="button"
        >
      ...
      <a href="mailto:akhilesh.balaji.bangalore[at]gmail.com?subject=Request for CV">
        <button
          class="btn btn-soft btn-circle p-2"
          type="button"
        >

export default function Menu() {
  return (
    <div class="flex items-center gap-1 sm:gap-2 py-4 content-center backdrop-blur-lg bg-accent-content/60 px-4 rounded-2xl sm:rounded-3xl fixed top-2 border-2 border-neutral/50 z-50">
      <a href="/">
        <img
          class="h-7 sm:h-10"

  ...
  return (
    <WorkSection sectionTitle={'Courses'}>
      <WorkItem
        ...
        workDate={'Jun 2022'}
        workExtDesc={
          'In Jun 2022, I completed a course on Udemy pertaining to the creation of web applications using ReactJS. The course, in addition to giving me an insight into the compartmentalized architecture design prompoted by React, also taught me about state management through React Redux, and scaling up state managemant to applications with many components. This website was built using the knowledge from that course.'
        }

  ...
  return (
    <WorkSection sectionTitle={'Awards'}>
      <WorkItem
        ...
        workDate={'March 2022'}
        workExtDesc={
          'On March 12th of 2022, I, along with a team of 3 other members, won the prize for the first runner up, in a hackathon hosted by Neev Academy, Neev Hacks. We created a browser extension, written in traditional web development tools, that would assist students in the management of their time effectively, such that they could complete each of their tasks based on which one was most important. This was done taking into account the total screen time that each task would add up to, so that we could provide eye and mindfulness breaks in between. One of the hardest parts about creating this was programming the algorithm to order tasks, and decide on the amount of time required for each task.'
        }
